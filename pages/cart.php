...
<body>
    <div class="container">
        ...
        if (empty($cart_items)) {
            ...
            // Ensure $product_ids is not empty before using implode, to prevent SQL errors.
            if (!empty($product_ids)) {
                ...
                $products = []; // No products to fetch if cart_items was empty
            }
        ...
        <div class="cart-actions">
            ...
            <a href="checkout.php" class="button-proceed-to-checkout">Proceed to Checkout</a>
        </div>
    </div>
</body>
